...
public class CuentaAtras_Dios : MonoBehaviour {

	public GameObject motorCarreteraGO;
	public MotorCarreteras_GameManager_Dios motorCarreteraScript;
	...
	void InicioComponentes(){
		...
		motorCarreteraScript = motorCarreteraGO.GetComponent<MotorCarreteras_GameManager_Dios> ();
