...
public class BusObstaculo_Dificil : MonoBehaviour {
	...
	public Cronometro_Dificil cronometroScript1;
	...
	void Start(){
		...
		cronometroGO1 = GameObject.FindObjectOfType<Cronometro_Dificil> ().gameObject;
		cronometroScript1 = cronometroGO1.GetComponent<Cronometro_Dificil> ();
	...
	void OnTriggerEnter2D(Collider2D other){
		if(other.GetComponent<Carro>() != null){
			...
			if (this.gameObject.CompareTag ("Malo")) {
				...
				cronometroScript1.tiempo = cronometroScript1.tiempo - 30;
